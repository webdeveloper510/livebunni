  ...
  <body>
    <div class="main-outer">
     ...
     <div class="container">
	   <div class="row row11">
        	<div class="col-md-12">
            	<h3 class="Gallery_tittle">Gallery</h3>
            </div>
        </div>
        <div class="clear"></div>
        <div class="row templatemo_portfolio">
        	<div class="col-md-3 col-sm-12 test1">
            	<div class="gallery-item test1">
							...
							<img src="<?php echo base_url("image/gallery/center-1.jpg");?>" alt="gallery 4">
            ...
            <div class="col-md-3 col-sm-12">
            	<div class="gallery-item">
							<img src="<?php echo base_url("image/gallery/center-2.jpg");?>" alt="gallery 5">
							<div class="thumb_data"><span class="title"><strong><i class="fa fa-camera-retro" aria-hidden="true"></i></strong> Profile pictures</span><br>
							<span class="subtitle">5 Photos</span></div>
						</div>
            </div>
            <div class="col-md-3 col-sm-12 test1">
            	<div class="gallery-item">
				            <img src="<?php echo base_url("image/gallery/premium.png");?>" class="premium">
							<img src="<?php echo base_url("image/gallery/center-3.jpg");?>" alt="gallery 6">
							<div class="thumb_data"><span class="title"><strong><i class="fa fa-camera-retro" aria-hidden="true"></i></strong> Profile pictures</span><br>
							<span class="subtitle">5 Photos</span></div>
						</div>
            </div>
            <div class="col-md-3 col-sm-12">
            	<div class="gallery-item">
							<img src="<?php echo base_url("image/gallery/center-4.jpg");?>" alt="gallery 7">
							<div class="thumb_data"><span class="title"><strong><i class="fa fa-camera-retro" aria-hidden="true"></i></strong> Profile pictures</span><br>
							<span class="subtitle">5 Photos</span></div>
						</div>
            </div>
