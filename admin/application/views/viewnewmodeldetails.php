                    ...
                    <form id="demo-form2" method="post" action="#" enctype="multipart/form-data" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
							<b><?php echo $viewnewmodeldetails[0]['First_name'];?>
							</b>
                          </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <b><?php echo $viewnewmodeldetails[0]['Last_name'];?>
							</b>
                        </div>
                      </div> 
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <b><?php echo $viewnewmodeldetails[0]['Username'];?>
							</b>
                        </div>
                      </div>
					   <?php 
					  if($viewnewmodeldetails[0]['address']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pincode">Address 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <b><?php echo $viewnewmodeldetails[0]['address'];?>
							</b>
                        </div>
                      </div> <?php } ?>
					  <?php 
					  if($viewnewmodeldetails[0]['Zipcode']){
					  ?>
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b>
						<?php echo $viewnewmodeldetails[0]['Zipcode'];?>
							</b>
					  ...
					  <?php } ?>
					    <?php 
					  if($viewnewmodeldetails[0]['Dob']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Date of birth
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['Dob'];?>
							</b>
                         
                        </div>
                      </div>
					  <?php } ?>
					  	<?php  $profileimage = $viewnewmodeldetails[0]['profile_img']; 
						if($profileimage){
						?>
					  <div class="form-group">
						...
						<?php } ?>
						<?php 
					  if($viewnewmodeldetails[0]['Country']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Country
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['Country'];?>
							</b>
					  	...
					  	<?php } ?>
							<?php 
					  if($viewnewmodeldetails[0]['State']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">State
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['State'];?>
							</b>
					  	...
					  	<?php } ?>
							<?php 
					  if($viewnewmodeldetails[0]['Summary']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Summary
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['Summary'];?>
							</b>
					  ...
					  <?php 
					  if($viewnewmodeldetails[0]['gender2']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Sexuality
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['gender2'];?>
							</b>
					  ...
					  <?php } ?>
					  <?php 
					  if($viewnewmodeldetails[0]['levels']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Levels
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['levels'];?>
							</b>
					   ...
					   <?php } ?>
					   <?php 
					  if($viewnewmodeldetails[0]['levelwith']){
					  ?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Levelwith
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
						<b class="ab"><?php  echo $viewnewmodeldetails[0]['levelwith'];?>
							</b>
                         
                        </div>
                      </div>
					   <?php } 
					   ///  $doc1pic = $viewnewmodeldetails[0]['doc1pic']; 
						//if($doc1pic){?>
					  ...
					  <!--div class="form-group">
						...
						<?php //}  /// $doc2pic = $viewnewmodeldetails[0]['doc2pic']; 
						//if($doc2pic){
						?>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="distt">Document Pic
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <a href="<?php echo base_url('admin/index.php/backend/newmodelrequest') ?>" class="btn btn-success">Back</a>
                        </div>
                      </div>
