              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					$i=1;
					foreach($newmodelrequest as $memberinfo)
					{
					  ...
					  ?>
							...
							<td><a href="<?php echo base_url('admin/index.php/backend/viewnewmodeldetails/'.$memberinfo['User_id']) ?>" class="update">View</a></td>
							<td><?php if($status==0){ ?>
							<a href="<?php echo base_url('admin/index.php/backend/activemodel/'.$memberinfo['User_id']) ?>" class="update">Active a Model</a>
								<?php
							}else{ 
							?>
							<a href="<?php echo base_url('admin/index.php/backend/inactivemodel/'.$memberinfo['User_id']) ?>" class="update">Deactive a Model</a>
								<?php
